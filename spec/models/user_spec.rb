...
describe User do
  ...
  it "should create a new intance given a valid attribute" do
    User.create!(@attr)
  end  
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com, user@foo.bar.org, first.last@foo.jp, THE_USER@foo.com]
  ...
  describe "password validations" do 
    ...
    it "should require a matching password confirmation" do
      User.new(@attr.merge(:password_confirmation => "invalid")). #invalid doesn't match foobar
        should_not be_valid
    end
  ...
  describe "admin attribute" do
    ...
    it "should not be the default role" do
      @user.should_not be_admin
    end
    
    it "should be converatable to an admin" do
      @user.toggle!(:admin)
  ...
  describe "blocs associations" do
    ...
    describe "status feed" do
      ...
      it "should include the user's blocs" do
         @user.feed.include?(@bloc1).should be_true
         @user.feed.include?(@bloc2).should be_true
      end

      it "should not include a different user's microposts" do
         bloc3 = Factory(:bloc,
                       :user => Factory(:user, :email => Factory.next(:email)))
         @user.feed.include?(bloc3).should be_false
      end
    end
  end  
